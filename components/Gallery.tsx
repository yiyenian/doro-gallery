      ...
      <div className="max-w-[1960px] mx-auto px-4 pb-20">
        <div className="columns-1 gap-4 sm:columns-2 xl:columns-3 2xl:columns-4">
          {images.map((image) => (
            ...
            >
              {/* 🔴 调试专用：显示真实 ID (红色字) */}
              <div className="absolute top-2 left-2 z-50 bg-red-600 text-white text-[10px] font-mono px-2 py-1 rounded shadow-lg border border-red-400 select-text pointer-events-none">
                {image.public_id}
              </div>
            ...
            <div className="flex w-full flex-col border-t border-white/10 bg-[#18181b] md:h-full md:w-[420px] md:flex-none md:border-l md:border-t-0 z-20">
              <div className="flex items-center justify-between p-6 pb-2 border-b border-white/5 bg-[#18181b]">
                <div className="flex flex-col gap-1">
                    <span className="text-[10px] text-gray-500 font-mono">ID: {selectedImage.public_id}</span>
