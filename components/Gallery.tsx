            ...
            <div className="relative flex-1 bg-[#09090b] flex items-center justify-center p-4 md:p-8 group/nav">
              ...
              {selectedIndex > 0 && (
                <button 
                    ...
                    className="absolute left-4 top-1/2 -translate-y-1/2 p-3 rounded-full bg-black/40 text-white/70 hover:text-white hover:bg-black/60 border border-white/5 transition backdrop-blur-md opacity-0 group-hover/nav:opacity-100"
                >
                  <ChevronLeft size={24} />
                </button>
              )}
              ...
              <div className="flex-1 overflow-y-auto p-6 pt-2 space-y-8 scrollbar-thin scrollbar-thumb-gray-800 scrollbar-track-transparent">
                ...
                <div className="border-t border-white/5 pt-6">
                   ...
                   <div className="grid grid-cols-2 gap-3">
                      <div className="rounded-lg bg-white/5 p-3 border border-white/5 hover:bg-white/10 transition">
                          <p className="text-[10px] uppercase text-gray-500 mb-1">Dimensions</p>
                          <p className="text-sm font-medium text-gray-200 font-mono">{selectedImage.width} × {selectedImage.height}</p>
                      </div>
                      <div className="rounded-lg bg-white/5 p-3 border border-white/5 hover:bg-white/10 transition">
