...
export default function Gallery({ images }: { images: any[] }) {
    ...
    <div className="mb-6 last:mb-0 w-full">
      ...
      <div className="relative group w-full">
        <div className="w-full rounded-xl bg-white/5 backdrop-blur-md border border-white/10 p-5 shadow-inner transition-colors hover:bg-white/[0.07]">
            <div className="text-xs leading-7 text-gray-300 font-mono select-text whitespace-pre-wrap break-words max-h-[300px] overflow-y-auto scrollbar-thin scrollbar-thumb-gray-600 scrollbar-track-transparent pr-2">
  ...
  return (
    <>
      {/* --- 极致紧凑版 Hero --- */}
      {/* pt-24 刚好避开导航栏，pb-6 紧贴列表 */}
      <div className="relative pt-24 pb-6 text-center px-4 w-full bg-transparent">
        <div className="max-w-3xl mx-auto relative z-10">
            
            {/* 标题与描述：大幅缩小，仅作点缀 */}
            <div className="mb-8">
                <h1 className="text-2xl sm:text-3xl font-extrabold tracking-tight text-white mb-2 drop-shadow-lg">
                  探索
                  <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-indigo-400 to-purple-400 px-2">
                    无限想象
                  </span>
                </h1>
                <p className="text-gray-400 text-xs sm:text-sm font-light opacity-80">
                  Doro Gallery - 全网高质量 AI 绘画提示词库
                </p>
            </div>

            {/* 搜索框：视觉重心 */}
            <div className="max-w-xl mx-auto relative group z-10 mb-6">
          ...
          <div className="relative w-full max-w-4xl bg-[#18181b] shadow-2xl ring-1 ring-white/10 rounded-2xl flex flex-col my-auto animate-in zoom-in-95 duration-200 overflow-hidden z-50 max-h-[95vh]">
            ...
            <div className="flex items-start justify-between p-6 pb-4 border-b border-white/5 bg-[#18181b]/95 backdrop-blur-md shrink-0 z-10 sticky top-0">
                <div className="flex-1 mr-4">
                    <h2 className="text-lg md:text-xl font-bold text-white leading-tight tracking-tight mb-2">{selectedImage.title}</h2>
