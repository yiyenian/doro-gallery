...
export const revalidate = 0; // 强制不缓存
    ...
    <main className="min-h-screen bg-[#121212] selection:bg-indigo-500/30">
      ...
      <div className="relative pt-32 pb-12 sm:pt-40 sm:pb-16 text-center px-4 max-w-5xl mx-auto">
        <h1 className="mb-8 text-5xl font-extrabold tracking-tight text-white md:text-7xl lg:text-8xl">
          ...
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 via-purple-400 to-pink-400 animate-pulse">AI Generation</span>
        </h1>
      ...
      <footer className="mt-20 border-t border-white/5 bg-[#121212] p-12 text-center text-gray-600 text-sm">
        <p>&copy; 2024 Doro Gallery. Powered by Vercel.</p>
      </footer>
    </main>
  );
}
