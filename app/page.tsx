...
export default async function Page() {
  ...
  return (
    <main className="min-h-screen bg-[#121212] selection:bg-indigo-500/30 text-white relative overflow-x-hidden">
      ...
      {/* 顶部导航栏 (高度 h-14，背景更透) */}
      <header className="fixed top-0 left-0 z-50 w-full border-b border-white/5 bg-[#121212]/60 backdrop-blur-md transition-all">
        <div className="mx-auto flex h-14 max-w-[1960px] items-center justify-between px-4 sm:px-6">
          <div className="flex items-center gap-3">
            <div className="flex h-7 w-7 items-center justify-center rounded-lg bg-gradient-to-tr from-indigo-600 to-violet-600 shadow-lg shadow-indigo-500/20 group hover:scale-105 transition-transform duration-300">
            ...
            <span className="text-base font-bold tracking-tight text-white/95 font-sans">Doro Gallery</span>
          </div>
          <div></div>
        </div>
      </header>
