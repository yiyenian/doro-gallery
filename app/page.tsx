  ...
  return (
    <main className="min-h-screen bg-[#121212] selection:bg-indigo-500/30 text-white relative overflow-x-hidden">
      ...
      <div className="fixed inset-0 -z-10 pointer-events-none">
        {/* 左上紫光：缓慢呼吸移动 */}
        <div className="absolute top-[-10%] left-[-10%] h-[600px] w-[600px] rounded-full bg-purple-900/20 blur-[120px] opacity-40 animate-blob" />
        
        {/* 右上蓝光：延迟移动 */}
        <div className="absolute top-[10%] right-[-10%] h-[500px] w-[500px] rounded-full bg-indigo-900/20 blur-[100px] opacity-40 animate-blob animation-delay-2000" />
        
        {/* 底部青光：延迟更多 */}
        <div className="absolute bottom-[-20%] left-[20%] h-[600px] w-[600px] rounded-full bg-blue-900/10 blur-[120px] opacity-30 animate-blob animation-delay-4000" />
      </div>
