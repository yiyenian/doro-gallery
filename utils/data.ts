...
- **材质特写 (Texture & Zoom):** 选取 1-2 个关键部位进行放大特写。新增：物品质感特写: 增加对小物件材质的描绘（如口红膏体的润泽感、皮革纹理）。
...
ar 3:4  niji 6  style cute`,
  ...
  "dr-4_cscuhq": {
    ...
    promptCn: `**设计主题:**
一个代表“量子计算”的科技公司 Logo。图形主体是一个抽象的字母 "Q"，由发光的线条和点阵组成。
**风格:**
- 极简主义 (Minimalism)
- 扁平化设计 (Flat design)
- 矢量风格 (Vector)
...
no realistic, 3d, text, shadow  ar 1:1  v 6.0`,
  ...
  "dr-5_tiubjj": {
    ...
    promptCn: `**画面主体:**
一个透明的玻璃瓶，瓶子里装有一个微缩的魔法森林。微小的发光蘑菇，还有一条流动的微型河流。
**摄影风格:**
- 微距镜头 (Macro lens)
- 景深效果 (Bokeh)
- 移轴摄影 (Tilt-shift)
...
ar 4:5 stylize 250  v 6.0`,
  ...
  "dr-6_xwhvt1": {
    ...
    promptCn: `**建筑描述:**
一座白色的未来主义博物馆，坐落在海边。建筑线条流畅，呈现出有机的流体形状，风格类似扎哈·哈迪德 (Zaha Hadid)。
**环境与时间:**
